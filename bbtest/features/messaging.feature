Feature: Messaging behaviour
  ...
  Scenario: token
    ...
    Then lake responds with "BondsterRest BondsterImport/MSG1 req_id_2 token_2 EE"

    When lake recieves "BondsterImport/MSG1 BondsterRest token_3 req_id_3 NT X Y"
    And lake recieves "BondsterImport/MSG1 BondsterRest token_3 req_id_3 DT"
    Then lake responds with "BondsterRest BondsterImport/MSG1 req_id_3 token_3 TN"
    And lake responds with "BondsterRest BondsterImport/MSG1 req_id_3 token_3 TD"
